          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <ScrollAnimation>
              ...
              <p className="text-teal-100 text-base sm:text-lg mb-8">
                Start your fitness journey today with a free trial. No commitment
                required.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4 sm:px-0">
                ...
                <Link
                  href="/contact"
                  className="w-full sm:w-auto border-2 border-white/30 text-white px-8 py-4 rounded-full font-bold text-base sm:text-lg hover:border-white/60 transition-all text-center"
                >
                  Contact Us
                </Link>
              </div>
