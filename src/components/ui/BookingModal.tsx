    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div className="relative bg-white sm:rounded-2xl shadow-2xl w-full sm:max-w-md sm:mx-4 overflow-hidden animate-slide-up sm:animate-none sm:scale-100 max-h-[90vh] overflow-y-auto">
        <div className="bg-gradient-to-r from-teal-600 to-teal-700 p-5 sm:p-6 text-white sticky top-0 z-10">
          ...
          <h3 className="text-lg sm:text-xl font-bold mb-1">Book a Class</h3>
          {className && (
            <p className="text-teal-100 text-xs sm:text-sm pr-8">
              {className} {trainer && `| ${trainer}`}{" "}
              {day && time && `| ${day} ${time}`}
            </p>
          )}
        </div>
        ...
        <div className="p-5 sm:p-6 safe-bottom">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none text-sm"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none text-sm appearance-none bg-white"
                  >
              ...
              <button
                type="submit"
                className="w-full bg-teal-600 text-white py-3.5 rounded-xl font-semibold hover:bg-teal-700 transition-colors mt-2"
              >
                Confirm Booking
              </button>
            </form>
