...
import { Dumbbell, Instagram, Twitter, Youtube, Facebook, Mail, Phone, MapPin, Clock, Send } from "lucide-react";
  ...
  return (
    <footer className="bg-gray-900 text-white">
      ...
      <div className="flex flex-col lg:flex-row">
        {/* Map */}
        <div className="lg:w-1/2 h-[350px] lg:h-[400px]">
          <iframe
        ...
        {/* Opening Hours */}
        <div className="lg:w-1/2 bg-gray-800 flex items-center justify-center p-8 lg:p-12">
          <div className="w-full max-w-md">
            <h3 className="text-2xl font-bold text-green-400 mb-8 tracking-wide">OPENING HOURS</h3>
            <div className="space-y-4">
              {openingHours.map((item) => (
                <div key={item.day} className="flex items-center justify-between py-2 border-b border-gray-700 last:border-0">
                  <span className="text-gray-300 font-medium">{item.day}</span>
                  <span className={`font-semibold ${item.time === "Closed" ? "text-red-400" : "text-white"}`}>
                    {item.time}
                  </span>
                </div>
              ))}
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-6 leading-relaxed">
              At GOLD STANDARD GYM, we are committed to helping you reach your fitness goals. Our experience runs deep and our trainers know just how to get your adrenaline rushing.
            </p>
          ...
          <div className="flex flex-col items-center md:items-start">
            <h4 className="text-lg font-bold text-white mb-6">Get Social</h4>
            <div className="flex items-center gap-4">
              <a href="#" className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-teal-600 transition-colors">
          ...
          <div>
            {submitted ? (
              <div className="bg-gray-800 rounded-xl p-8 text-center h-full flex flex-col items-center justify-center">
